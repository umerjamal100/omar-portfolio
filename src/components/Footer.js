        ...
        >
          ...
          <Grid lg={4} md={4} sm={12} xs={12} item>
            <div className={classes.iconsContainer}>
              <a
                href="https://fb.com/umer.jamal.900/"
                target="_blank"
              ...
              <a
                href="https://github.com/umerjamal100"
                target="_blank"
                rel="noopener noreferrer"
              >
                <IconButton
              ...
              <a
                href="https://www.linkedin.com/in/umer-jamal-a83b9a11a/"
                target="_blank"
                rel="noopener noreferrer"
              >
                <IconButton
          ...
          <Grid lg={4} md={4} sm={12} xs={12} item>
            <div className={classes.textRight}>
              <Typography className={classes.copyRightText}>
                Made with <HeartIcon className={classes.heartIcon} /> by Omar
                Jamal in {currentYear}.
              </Typography>
            </div>
          </Grid>
        </Grid>
